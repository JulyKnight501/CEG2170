...
void two_player(int, int, int, int);
int r_num();
void hm_icon(int);
...
int main (void) {
    ...
    two_player(game_rounds, round_count, wrong_guess, wrong_counter);
...
void two_player(int game_rounds, int round_count, int wrong_guess, int wrong_counter){
